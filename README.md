...
|---|---|---|---|---|
| 1 | git clone | run the 110 code-only guardrails (38 skip without data) | ~25 s | 20 MB |
...
make test      # 152 collected. 144 pass from a clean extract of the release
               # archive; a bare clone runs 110 and skips 38 for want of data.
```
