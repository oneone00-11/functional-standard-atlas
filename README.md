...
|---|---|---|---|---|
| 1 | git clone | run the 91 code-only guardrails (37 skip without data) | ~25 s | 20 MB |
...
make test      # 128 collected. 126 pass from a clean extract of the release
               # archive; a bare clone runs 91 and skips 37 for want of data.
```
